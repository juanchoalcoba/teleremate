          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 relative z-10">
            <div>
              <h1 className="text-4xl md:text-6xl font-black text-gray-900 tracking-tight uppercase font-display mb-4">
                Nuestros <span className="text-gray-400">Catálogos</span>
              </h1>
              <p className="text-gray-500 max-w-xl text-sm md:text-base leading-relaxed font-medium">
                ...
                antigüedades y oportunidades únicas. Calidad verificada en cada
                remate.
              </p>
            </div>
        ...
        <div className="grow">
          {isError ? (
            <div className="flex flex-col items-center justify-center py-20 text-gray-500 bg-red-50/50 rounded-3xl border border-red-100">
              ...
              <p className="text-sm text-center max-w-sm mb-6 opacity-80">
