          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <p className="text-gray-600 text-base md:text-lg leading-relaxed max-w-xl">
                Es una plataforma que brinda servicios de consignación, subasta
                y venta directa en vivo y online.
              </p>
              <p className="text-gray-600 text-base md:text-lg leading-relaxed max-w-xl">
                A través de tecnología de streaming, catálogo web y atención
                telefónica, conecta compradores y vendedores de todo el país de
                forma ágil, segura y transparente. Fundada y dirigida por{" "}
                <span className="font-bold text-gray-900 whitespace-nowrap">
                  Virginia C. Tierno
                </span>{" "}
                y el{" "}
                <span className="font-bold text-gray-900 whitespace-nowrap">
                  Ing. Agr. Marcelo Mondino
                </span>
                .
              </p>
            </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-xs leading-relaxed">
                    Experiencia real con tecnología de streaming de alta
                    calidad.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all group">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-xs leading-relaxed">
                    Transacciones protegidas y procesos verificados para su
                    tranquilidad.
                  </p>
                </div>
              </div>
